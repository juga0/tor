...
extensions = [
    # Required by breathe
    # sphinx.ext.pngmath has been deprecated.
    'sphinx.ext.imgmath',
    'breathe'
]
...
# -- Breathe options to generate code documentation from doxygen.
breathe_projects = {
    'Tor codebase documentation': 'doxygen/xml'
}
breathe_default_project = 'Tor codebase documentation'

# Even with this option, sphinx tries to parse functions with cpp.py
primary_domain = 'c'
